package
{
	...
	public class ScreenBookDetail extends MovieClip
	{
	//LLISTAT ELEMENTS DE LA SCREEN
		//BOTO BACK PANTALLA SCREENSEARCH
		public var bt_back_BookDetail:SimpleButton;
		...
		//ALTRES TEXTOS
		public var bookTitle_tf;
		public var bookAuthor_sp;
		public var bookPublisher_sp;
		public var bookNumPages_tf;
		public var bookRating_tf;
		public var bookFree_tf;
		public var dls_Photo;
		public var bookDescription_sp;
	...
	//FI LLISTAT ELEMENTS SCREEN
		...
		public function ScreenBookDetail(title:String)
		{
			super();
		...
		public function refreshScreen(ev:Event=null):void {
			...
			if ( stageW>stageH ) {
				...
				//BOTO FAVORITS
				btMyFavorites_sp.y=352;
				btMyFavorites_sp.x=30;

				bookDescription_sp.x = bgScreen_sp.width/2-gutter;
				bookDescription_sp.y = 130;
				...
				bookDescription_sp.x=30;
				bookDescription_sp.y=352;
				
				//BOTO FAVORITS
				btMyFavorites_sp.y=680;
